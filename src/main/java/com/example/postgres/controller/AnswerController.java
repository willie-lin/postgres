...
import com.example.postgres.repository.AnswerRepository;
...
public class AnswerController  {
    ...
    public List<Answer> getAnswerQuestionId(@PathVariable Long questionId){
    ...
    public ResponseEntity<?> deleteAnswer(@PathVariable Long questionId,
        ...
        }).orElseThrow(() -> new ResourceNotFoundException("Answer not found with answerId" + answerId));
    }
}